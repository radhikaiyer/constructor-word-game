...
var wordList = ["austin", "houston", "dallas", "new york", "los angeles", "chicago", "seattle", "washington", "orlando", "san francisco", "san diego", "phoenix"];
...
function checkIfUserWon() {
	...
	//else if the number of slots/underscores that are filled in with a letter equals the number of letters in the word, the user won.
		...
		console.log(gameTextColor("====================================================================="));
		console.log(correct("YOU WON! YOU REALLY KNOW THE MAJOR US CITIES!"));
